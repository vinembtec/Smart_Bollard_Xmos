...
#Copy Latest .xe file to filesystem_support_seperate/filesystem_support_seperate_EmQos folder
sudo cp ~/xcore_sdk/build/example_freertos_explorer_board.xe ~/xcore_sdk/examples/freertos/explorer_board/filesystem_support_seperate/ --verbose
sudo cp ~/xcore_sdk/build/example_freertos_explorer_board.xe ~/xcore_sdk/examples/freertos/explorer_board/filesystem_support_seperate_EmQos/ --verbose
...
#DEMO_TXT=~/xcore_sdk/examples/freertos/explorer_board/filesystem_support_seperate/demo.txt
#XMOS_IMAGE=~/xcore_sdk/examples/freertos/explorer_board/filesystem_support_seperate/IMG_FL_1111_32092_20220803_111940_01.jpg
#XMOS_CONFIG=~/xcore_sdk/examples/freertos/explorer_board/filesystem_support_seperate/config.ini

#W25X101=~/xcore_sdk/examples/freertos/explorer_board/filesystem_support_seperate/W25X101.pdf
...
sudo cp $DEMO_TXT fat_mnt/fs/demo.txt --verbose
sudo cp $XMOS_IMAGE fat_mnt/IMG_FL_1111_32092_20220803_111940_01.jpeg --verbose
sudo cp $XMOS_CONFIG fat_mnt/config.ini --verbose

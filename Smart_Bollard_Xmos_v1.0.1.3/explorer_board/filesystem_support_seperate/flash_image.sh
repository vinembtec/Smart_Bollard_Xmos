...
##xflash --quad-spi-clock 50MHz --factory ~/xcore_sdk/build/example_freertos_explorer_board.xe --boot-partition-size 0x100000 --data ~/xcore_sdk/examples/freertos/explorer_board/filesystem_support_seperate/example_freertos_explorer_board_fat.fs --verbose

...
#define INTERTILE_RPC_HOST_TASK_PRIORITY (configMAX_PRIORITIES/2)

//#define INTERTILE_TEST_SYNC_PORT 11
//#define INTERTILE_TEST_SYNC_TASK_PRIORITY (configMAX_PRIORITIES/2)
...
/* Task Priorities */
#define appconfSTARTUP_TASK_PRIORITY            ( configMAX_PRIORITIES - 7 )
#define appconfCAPTURE_TASK_PRIORITY            ( configMAX_PRIORITIES - 5 )
//#define appconfAUDIO_PIPELINE_TASK_PRIORITY    	( configMAX_PRIORITIES - 6 )
#define appconfGPIO_TASK_PRIORITY              	( configMAX_PRIORITIES - 6 )
#define appconfFILESYSTEM_DEMO_TASK_PRIORITY    ( configMAX_PRIORITIES - 3 )
#define appconfMEM_ANALYSIS_TASK_PRIORITY		( configMAX_PRIORITIES - 5 )
//#define appconfSPI_MASTER_TASK_PRIORITY		    ( configMAX_PRIORITIES - 3 )
#define appconfQSPI_FLASH_TASK_PRIORITY		    ( configMAX_PRIORITIES - 4 )

#define appconfUART_RXD1_TASK_PRIORITY		    ( configMAX_PRIORITIES - 1 )
#define appconfUART_RXD2_TASK_PRIORITY		    ( configMAX_PRIORITIES - 2 )
#define appconfUART_TXD_TASK_PRIORITY		    ( configMAX_PRIORITIES )
#endif /* APP_CONF_H_ */
